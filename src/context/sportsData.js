const sportsData = {
	futbol11: {
	  title: 'Fútbol 11',
	  img: 'https://images-atletico-sanabria.s3.amazonaws.com/sports/futbol112.jpg',
	...
	padel: {
	  title: 'Pádel',
	  img: 'https://images-atletico-sanabria.s3.amazonaws.com/sports/padel2.jpg',
	  ...
	  equipment: '4 canchas de pádel iluminadas, área de descanso, vestuarios, etc.',
	  // Añade información sobre torneos de pádel o eventos especiales si los tienes.
	},
	ciclismo: {
	  title: 'Ciclismo',
	  img: 'https://images-atletico-sanabria.s3.amazonaws.com/sports/biking2.jpg',
	  ...
	  equipment: 'Bicicleta de montaña, casco, botellas de agua, ropa adecuada, etc.',
